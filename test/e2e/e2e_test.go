...
const namespace = "template-k8s-system"

// serviceAccountName created for the project
const serviceAccountName = "template-k8s-controller-manager"

// metricsServiceName is the name of the metrics service of the project
const metricsServiceName = "template-k8s-controller-manager-metrics-service"

// metricsRoleBindingName is the name of the RBAC that will be created to allow get the metrics data
const metricsRoleBindingName = "template-k8s-metrics-binding"
